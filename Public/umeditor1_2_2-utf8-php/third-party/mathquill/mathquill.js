...
var P = (function(prototype, ownProperty, undefined) {
  ...
  function P(_superclass /* = Object */, definition) {
    ...
    // Category is the class to be returned.
    //
    // It delegates to instantiating an instance of `Bare`, so that it
    // will always return a new instance regardless of the calling
    // context.
    //
    //  TODO: the Chrome inspector shows all created objects as `Category`
    ...
    // Category.Bare is a class with a noop constructor.  Its prototype is the
    // same as Category, so that instances of Category.Bare are also instances of Category.
  ...
  // and the string 'prototype' (Category[p] is much shorter than Category.prototype)
...
var manageTextarea = (function() {
  ...
  return function manageTextarea(el, opts) {
    ...
    function typedText() {
      ...
      // selection in the textarea alone, such as Ctrl-Category.
...
var MathCommand = P(MathElement, function(_, _super) {
  ...
  /*
    ...
    - For each block of the command, there must be exactly one "block content
      ...
      1-based index, because JavaScript because Category because Dijkstra.)
...
LatexCmds.complexplane = LatexCmds.Complexplane = LatexCmds.ComplexPlane =
  bind(VanillaSymbol,'\\mathbb{Category}','&#8450;');
